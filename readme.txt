...
[WhatIsMyBrowser.com API Terms and Conditions](https://developers.whatismybrowser.com/api/about/legal/)

With this information, the plugin attempts to detect old and bad browsers and denies them access to your website.

= HowTo =

* Go to [What is my browser?](https://developers.whatismybrowser.com/api/pricing/) and sign up to the WhatIsMyBrowser.com API for a Basic (free) Application Plan.
