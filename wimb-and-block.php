...
require_once __DIR__ . '/php/wimb-tables.php';
...
require_once __DIR__ . '/php/crawler-settings.php';
...
require_once __DIR__ . '/php/sec-fetch.php';
if ( file_exists( __DIR__ . '/php/sec-fetch-test.php' ) ) {
	require_once __DIR__ . '/php/sec-fetch-test.php';
}
if ( file_exists( __DIR__ . '/php/wimb3.php' ) ) {
	require_once __DIR__ . '/php/wimb3.php';
}
if ( is_admin() ) {
	...
	require_once __DIR__ . '/admin/crawler.php';
...
register_deactivation_hook( __FILE__, 'wimbblock_deactivate' );

// Disable activation the other of WP / Github Version
if ( ! function_exists( 'wimbblock_disable_activation' ) ) {
	function wimbblock_disable_activation( $actions, $plugin_file ) {
