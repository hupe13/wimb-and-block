...
2. Access attempts from the same IP address blocked within 15 seconds: <br>![Access attempts from the same IP address blocked within 15 seconds](.wordpress-org/screenshot-2.png)
