...
function wimbblock_logfile_init() {
	add_settings_section( 'logfile_settings', '', '__return_empty_string', 'wimbblock_settings_logfile' );
	...
	register_setting(
		'wimbblock_settings_logfile',
		'wimbblock_logfile',
		array(
			'type'              => 'string',
			'sanitize_callback' => 'wimbblock_validate_logfile',
			'default'           => null,
		)
	);
}
