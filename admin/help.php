...
function wimbblock_help() {
	...
	. '</li>' . "\n\r";
	$text .= '<li class="adminli">' . __( 'The user agent string of every browser accessing your website the first time is send to this service and some data will be stored in this table:', 'wimb-and-block' ) . "\n\r";
	...
	$text .= '</li>';
	$text .= '<li class="adminli">' . __( 'You can configure other browsers too.', 'wimb-and-block' ) . '</li>' . "\n\r";

	$text .= '<li class="adminli">' . __( 'Sometimes there are false positive, for example if the browser is from Mastodon. Then you can exclude these from checking.', 'wimb-and-block' ) . '</li>' . "\n\r";
	$text .= '<li class="adminli">' . __( 'The plugin checks, if the crawlers are really from Google, Bing, Yandex, Apple, Mojeek, Baidu, Seznam.', 'wimb-and-block' ) . '</li>' . "\n\r";
	$text .= '</ul>' . "\n\r";
